    ...
    <div class="main-container">
      ...
      <div class="page-cover">
        <form action="basketball.php" method="post">
          <div class="text-form"> <label for="">Full Name:</label><input type="text" name="fname" readonly value="<?php echo $_SESSION['firstname']; ?>"></div><br>
          <div class="text-form"><label for="">Sport:</label><input type="text" value="Basketball" name="sport" readonly></div><br>
          <div class="text-form"> <label for="">Weight in (kg):</label><input type="number" name="weight" id="" value="<?php echo $_SESSION['weight']; ?>"></div><br>
